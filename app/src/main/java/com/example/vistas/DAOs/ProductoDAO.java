...
public class ProductoDAO implements Code_DB {
    ...
    public ArrayList<Producto> select_all() {
        ...
        while (cursor.moveToNext()) {
            Producto productoAux = new Producto(cursor.getInt(0), cursor.getString(1), cursor.getInt(2), cursor.getString(3), cursor.getString(4));
    ...
    public ArrayList<Producto> select_where_idLista(int idLista){
        ...
        while (cursor.moveToNext()) {
            categoriaAux = new Producto(cursor.getInt(0), cursor.getString(1));
    ...
    // * DELETE ->
    public int delete_where_idProducto(int id) {
        String pa[] = {(id + "")};
